...
Делегирование решает две главные проблемы: **экономия дорогих токенов** и **параллелизм**. Вместо того чтобы заставлять дорогой `Claude 3.5 Sonnet` скроллить 20 сайтов, он поручает это быстрому и дешевому `Gemini Flash Lite`, который сделает всю грязную работу в фоне и принесет готовую выжимку.
