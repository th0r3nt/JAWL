...
@pytest.mark.asyncio
async def test_look_at_image_success(vision_skills, mock_os_client, tmp_path):
...
@pytest.mark.asyncio
async def test_look_at_image_unsupported_ext(vision_skills, mock_os_client, tmp_path):
...
@pytest.mark.asyncio
async def test_look_at_image_permission_error(vision_skills, mock_os_client):
    ...
    res = await vision_skills.look_at_image("/root/secret.jpg")
