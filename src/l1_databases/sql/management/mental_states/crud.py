...
class SQLMentalStates:
    ...
    async def create_mental_state(
        ...
        """
        Регистрирует новую сущность (человека, сервер, проект, место) для отслеживания.

        Args:
            name: Название объекта или имя субъекта.
            tier: Уровень важности.
            category: Классификатор.
            description: Описание того, что это такое.
            status: Текущее состояние.
            attitude: Опционально. Субъективное отношение к сущности (например 'Friendly', 'Suspicious', 'Hostile').
            directives: Опционально. Индивидуальные правила/рекомендации взаимодействия с этой сущностью.
            relations: Опционально. Словарь связей вида {"ID_другой_сущности": "Описание связи"}.
        """
