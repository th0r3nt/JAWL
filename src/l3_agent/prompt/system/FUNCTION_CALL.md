...
2. `actions`: Массив инструментов для исполнения. Можно вызывать параллельно. Если функция требует передачи аргументов (в описании есть флаг <REQUIRED>) - необходимо передавать их в блоке parameters сооветствующей функции.
