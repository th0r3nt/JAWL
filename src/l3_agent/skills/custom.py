...
class CustomSkillsRegistry:
    ...
    def load_and_register_all(self):
        """
        Читает манифест и регистрирует прокси-функции в ядро агента при старте.
        """
    ...
    def _create_and_register_proxy(self, skill_name: str, info: Dict[str, Any]):
        ...
        async def dynamic_proxy(**kwargs):
    ...
    def register_skill(
        ...
        """
        Сохраняет навык в JSON и регистрирует в рантайме.
        """
